...
def test_funding_boundary_store_v8_cannot_alias_historical_v1_v2_v3_v4_v5_v6_or_v7_path_or_identity(
    tmp_path: Path,
) -> None:
    ...
    assert FUNDING_BOUNDARY_RUN_STORE_BASENAME == (
        ".risex-funding-farmer-nado-funding-boundary-eth-v8.sqlite3"
    )
