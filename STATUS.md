...
B2 is approaching a preserved checkpoint, not acceptance: candidate S3 source `b2231e335ba4b121953c02697954d790e616038106c599ad2e145db662f3b830` passes Chief second-pass mutation checks, 18 aggregation comparisons and a constant-retention driver probe; its D1 report is independently byte-identical to the immutable 8,561-byte report. Builder reports 95 focused tests passing. Final candidate SHA, full suite and measured peak remain pending.

A newly confirmed core-memory defect prevents whole-path acceptance. Accepted `cycle.py` SHA-256 `b91a33378855c8e00daff43aacfc54a7322033360ad4584bbe904d54fce59b4d` retains every unique full book in `_MutableCycle.books` and retains mutable terminal cycles. Chief direct probe retained 102/1002/2002 books after 100/1000/2000 additions, with about 80KB/831KB/1.58MB object overhead even when book levels are shared. Real candidate replay reached about 1,158,944 KiB RSS; a final measured run is pending. The observed plateau after this campaign's early lane halts does not prove boundedness for longer active cycles. Evidence is in `B2-chief-core-book-retention.json` and the two `B2-chief-*-b2231e335ba4.json` runtime artifacts. B2 forbids kernel edits; Builder must finish its current measurement/checkpoint and stop before a fresh centrally authorized kernel-memory successor. The goal remains active; this scope conflict has an available next correction, not an administrative impasse.
