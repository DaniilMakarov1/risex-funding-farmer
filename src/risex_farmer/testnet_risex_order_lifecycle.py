...
OFFICIAL_MARKET_ID = 2
OFFICIAL_MARKET_SYMBOL = "ETH/USDC"
OFFICIAL_MARKET_TICK = Decimal("0.01")
OFFICIAL_MARKET_STEP = Decimal("0.001")
OFFICIAL_MARKET_MINIMUM = Decimal("0.1")
