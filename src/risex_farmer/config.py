...
class PaperConfig:
    ...
    extended_required_metadata_max_age_seconds: int = 300
    extended_universe_refresh_seconds: int = 600
    extended_universe_max_age_seconds: int = 1200
    extended_catalog_timeout_seconds: int = 60
...
EXTENDED_REQUIRED_METADATA_MAX_AGE_SECONDS = PAPER_CONFIG.extended_required_metadata_max_age_seconds
...
EXTENDED_CATALOG_TIMEOUT_SECONDS = PAPER_CONFIG.extended_catalog_timeout_seconds
