...
FUNDING_BOUNDARY_PRIMARY_JOURNAL = (
    ".risex-funding-farmer-risex-nado-boundary-primary-v1.sqlite3"
)
FUNDING_BOUNDARY_COUNTERPARTY_JOURNAL = (
    ".risex-funding-farmer-risex-nado-boundary-counterparty-v1.sqlite3"
)
FUNDING_BOUNDARY_PRIMARY_STORE_IDENTITY = "risex-nado-boundary-primary-v1"
FUNDING_BOUNDARY_COUNTERPARTY_STORE_IDENTITY = "risex-nado-boundary-counterparty-v1"
