...
Status: `BLOCKED — NADO RATE-LIMIT CADENCE CORRECTION IS ACCEPTED, BUT A FRESH AUTHENTICATED READ-ONLY PREFLIGHT IS STILL REQUIRED; EXTENDED TESTNET BOOKS HAVE ZERO ASKS AND A STALE FUNDING TIMESTAMP; NO WRITE IN FLIGHT`.
