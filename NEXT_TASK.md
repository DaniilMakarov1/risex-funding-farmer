...
Implementation owner: Chief task `01a0cc6e-175d-7582-a7ad-74a9601e2ca1`, host `local`, worktree `/Users/daniilmakarov/.codex/worktrees/671e/RISEx Spread Shadow`. Create the unoccupied branch `codex/spread-v1-hcr41-audit-corrections` from the assignment seed commit supplied with dispatch, after verifying root/HEAD/cleanliness. Preserve any intervening work instead of overwriting it. Own the current hood_handoff package, directly relevant tests and coherent updates to the five governing files. Do not edit frozen modules or other repositories.
