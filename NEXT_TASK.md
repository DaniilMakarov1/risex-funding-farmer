...
- Fetch exact official nonce state for the fixed wallet. Use `nonce_anchor + 1` and bitmap index `0`, as prescribed by the official integration contract. Reject overflow, index outside `0..207`, malformed/change-in-flight nonce, or identity mismatch before signing.
