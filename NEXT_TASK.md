...
Status: `BLOCKED — NADO LIVE FUNDING ADAPTER IS ACCEPTED BUT REQUIRES A FRESH AUTHENTICATED READ-ONLY PREFLIGHT BEFORE THE AUTHORIZED LIFECYCLE; EXTENDED TESTNET BOOKS HAVE ZERO ASKS AND A STALE FUNDING TIMESTAMP; NO WRITE IN FLIGHT`.
