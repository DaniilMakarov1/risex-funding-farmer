...
- The central parallel-lane governance prerequisite is fulfilled at exact published `main == origin/main == 34294c396e53e5a92e3d0a08d20faff5fff69196`. This file currently contains exactly one active bounded slice, the RISEx blocker above. Nado and Extended have no active slice and remain research-only; a Builder there still requires that venue's accepted Phase 0 and a separate accepted central governance gate.
