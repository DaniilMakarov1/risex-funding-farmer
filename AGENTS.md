...
- Chief uses GPT-5.6 Sol `medium`. Builders use GPT-5.6 Luna `max`. Builder `high`/`xhigh` and all Pro modes are prohibited; no other model/effort substitution is allowed without explicit user approval.
